...
public class TestEnemy {
    ...
    void setUp() {
        ...
        manager.setEnemyCoord(0, 0);
        manager.enemy.setSpeed(0.05f);
    }
    ...
    public void testEnemyEscape_ChangesToWaiting() {
        ...
        manager.addBomb(new BombFactoryImpl(manager, null).CreateBomb(Optional.empty(), new Pair(0, 1), 1));
        manager.enemy.update(STANDARD_ELAPSED_TIME);
        manager.enemy.update(STANDARD_ELAPSED_TIME);
        assertEquals(Enemy.State.ESCAPE, manager.enemy.getState());
        manager.updateGame(STANDARD_ELAPSED_TIME);
    ...
    private static class TestGameManager implements GameManager {
        ...
        public TestGameManager() {
            ...
            BombFactory b = new BombFactoryImpl(this, null);
            enemy = new Enemy(this, new Coord(0.5f, 0.5f), b);
            player = new Player(this, new Coord(12.5f, 12.5f), b);
        }
