...
/**
 * This abstract class provides default implementations for equals and hashCode
 * methods for all enemy states.
 */
public abstract class AbstractEnemyState implements EnemyState {
     ...
     * @return true if the specified object is of the same class as this state;
     *         false otherwise
     */
    @Override
     ...
     * The hash code is a constant value, ensuring that all instances of the same
     * state class have the same hash code.
     * 
     * @return the hash code value, which is a constant 31
     */
    @Override
    public int hashCode() {
        return VALUE; // arbitrary constant value
    }
